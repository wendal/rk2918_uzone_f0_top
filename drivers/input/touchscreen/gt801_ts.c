...
const unsigned char GT801_RegData[GT801_REGS_NUM]={	
	0x13,0x05,0x04,0x28,0x02,0x14,0x14,0x10,0x50,0xBA,0x03,0x00,0x04,0x00,0x01,
	0x23,0x45,0x67,0x89,0xAB,0xCD,0xE1,0x00,0x00,0x00,0x00,0x4D,0xC1,0x20,0x01,
	0x01,0x83,0x50,0x3C,0x1E,0xB4,0x00,0x33,0x2C,0x01,0xEC,0x3C,0x64,0x32,0x71,
...
//			}
			...
			input_report_abs(ts->input_dev, ABS_MT_PRESSURE, buf[i+ptpressure]);
...
static int gt801_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	snprintf(ts->phys, sizeof(ts->phys), "%s/input1", dev_name(&client->dev));
	...
	input_set_abs_params(ts->input_dev,ABS_Y,
      ...
      ts->input_dev->absbit[0] = BIT(ABS_MT_POSITION_X) | BIT(ABS_MT_POSITION_Y) | BIT(ABS_MT_PRESSURE) | BIT(ABS_MT_TOUCH_MAJOR);  // for android
