...
#define CONFIG_SENSOR_0                       /* back camera sensor */
...
#define CONFIG_SENSOR_1 RK29_CAM_SENSOR_MT9M112                      /* front camera sensor */
#define CONFIG_SENSOR_IIC_ADDR_1 	    0xBA
...
#define	GT801_SW_PIN	RK29_PIN5_PA0
#define	GT801_INIT_PIN	RK29_PIN0_PA2

struct gt801_platform_data gt801_ts_info = {
	.model = 801,
	.swap_xy = 1,
	.x_min = 0,
	.x_max = 1024,
	.y_min = 0,
	.y_max = 768,
	.gpio_reset = GT801_SW_PIN,
	.gpio_reset_active_low = 0,
	.gpio_pendown = GT801_INIT_PIN,
	.pendown_iomux_name = "gt801_pendown",
	.resetpin_iomux_name = "gt801_resetPin",
	.pendown_iomux_mode = 0,
...
struct rk2818_headset_data rk2818_headset_info = {
	...
	.irq		= RK29_PIN5_PA6,//Detection Headset--Must be set
	.irq_type	= KEY_MEDIA,
};
...
#define BL_EN_PIN         RK29_PIN1_PB5
...
#define RK29SDK_WIFI_SDIO_CARD_DETECT_N    RK29_PIN1_PC0
